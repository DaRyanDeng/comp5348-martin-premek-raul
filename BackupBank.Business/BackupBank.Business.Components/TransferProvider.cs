        ...
        public void Transfer(double pAmount, int pFromAcctNumber, int pToAcctNumber)
        {
            ...
            using (TransactionScope lScope = new TransactionScope())
                using (BackupBankEntityModelContainer lContainer = new BackupBankEntityModelContainer())
                {
                    ...
                    lLogMessage = "Transfer Request Succeeded (pAmount=" + pAmount + " , pFromAcctNumber=" + pFromAcctNumber + " , pToAcctNumber=" + pToAcctNumber + " )"; //we have to fill this within transaction scope or VS goes mad
