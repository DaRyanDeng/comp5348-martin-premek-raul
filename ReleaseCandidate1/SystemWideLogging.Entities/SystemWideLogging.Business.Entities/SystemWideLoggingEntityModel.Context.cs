...
{
    public partial class SystemWideLoggingEntityModelContainer : ObjectContext
    {
        public const string ConnectionString = "name=SystemWideLoggingEntityModelContainer";
        public const string ContainerName = "SystemWideLoggingEntityModelContainer";
    
        #region Constructors
    
        public SystemWideLoggingEntityModelContainer()
            : base(ConnectionString, ContainerName)
        {
            Initialize();
        }
    
        public SystemWideLoggingEntityModelContainer(string connectionString)
            : base(connectionString, ContainerName)
        {
            Initialize();
        }
    
        public SystemWideLoggingEntityModelContainer(EntityConnection connection)
