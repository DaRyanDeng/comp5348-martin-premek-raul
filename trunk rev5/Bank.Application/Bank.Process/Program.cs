...
namespace Bank.Process
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            SystemWideLogging.InitiateClass(); //pseudo constructor;
            ...
            SystemWideLogging.LogServiceClient.LogEvent("Bank :: Bank.Application\\Bank.Process\\Program.cs :: static void Main(string[] args)", "Service stopped");
