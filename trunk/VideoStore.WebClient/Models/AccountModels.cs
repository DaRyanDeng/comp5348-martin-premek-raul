...
using VideoStore.WebClient.CustomMembership;
using Common;
...
namespace VideoStore.WebClient.Models
{
    ...
    public class RegisterModel : IVisitable
    {
        [Required]
        [DisplayName("User name")]
        public string UserName { get; set; }
    ...
    public interface IMembershipService
    {
        ...
        MembershipCreateStatus CreateUser(string userName, string password, string pPostalAddress,  string email);
